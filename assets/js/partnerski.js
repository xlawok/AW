...
//   var timeEl = document.querySelector('.time-cursor input');
  ...
  if(window.offsetWidth>1600){
    var numberOfElements = 171;
  }
  else{
    var numberOfElements = 135;
  }
...
//   }, 0)
  ...
  var all_steps = document.querySelectorAll('.animation .feature-caption');
  for (var i = 0; i < all_steps.length; i++){
    
      isElementInViewport(all_steps[i], function(el, entry) {
